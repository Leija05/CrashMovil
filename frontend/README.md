...
- The Settings tab now includes a Bluetooth LE scan/connect section to bind an HM-10/HC-05 telemetry module.
- The app expects BLE notification payloads coming from HM-10/HC-05 with newline (`\\n`) delimiter.
